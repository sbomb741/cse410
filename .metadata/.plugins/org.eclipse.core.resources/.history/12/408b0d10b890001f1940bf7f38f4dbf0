...
startPrompt:		.string		27, "[2J", 27, "[1;1H", 27, "[37;40m"
					...
					.string 	0xA, 0xD, 0x9, "	- Note that code 0 will activate pwm, and any invalid keystroke will pause the rainbow"
					.string 	0xA, 0xD, 0x9, "	- Note that entering, leaving, and entering code 0 will use GP timer, pwm module, GP timer"
